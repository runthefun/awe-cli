import { AgoraComponent } from '../../components/agora/component';
import { AppStateOpts } from '..';
import { AudioComponent as AudioComponent_2 } from '../../../scripting';
import { AvatarComponent as AvatarComponent_2 } from '../../../scripting';
...
import { BirdComponent as BirdComponent_2 } from '../../../scripting';
import { BirdStaticComponent } from '../../components/birdstatic/birdstaticcomponent';
import { BirdStaticComponentData } from './birddata';
import { Box3 } from 'three';
import { BoxGeometry } from 'three';
import { BufferAttribute } from 'three';
import { BufferGeometry } from 'three';
import { BulletComponent as BulletComponent_2 } from '../../../scripting';
...
import { CloudComponent as CloudComponent_2 } from '../../../scripting';
...
import { Component3DData as Component3DData_3 } from '../../../../scripting';
import { Component3DData as Component3DData_4 } from 'engine/scripting';
import { Component3DData as Component3DData_5 } from '../../../scripting';
import { ComponentInfo as ComponentInfo_2 } from '../../../abstract/componentinfo';
...
import { DustComponent as DustComponent_2 } from '../../../scripting';
...
import { GodrayComponent as GodrayComponent_2 } from '../../../scripting';
import { GrassComponent } from '../../components/grass/grasscomponent';
...
import { ImageComponent as ImageComponent_2 } from '../../../scripting';
import { ImpactComponent } from '../../components/impact/impactcomponent';
import { InstancedBufferGeometry } from 'three';
import { InstancedMeshComponent } from '../../components/instancedmesh/instancedmeshcomponent';
...
import { InternalConfig as InternalConfig_3 } from '../api/scriptparams';
import { Intersection } from 'three';
import { JsonRpcApiProvider } from 'ethers/providers';
import type { JsonRpcProvider } from 'ethers';
import { KitBashComponent as KitBashComponent_2 } from '../../../scripting';
import { LightingComponent as LightingComponent_2 } from '../../../scripting';
import { Line2 } from 'three/examples/jsm/lines/Line2.js';
import { MagneticFieldComponent as MagneticFieldComponent_2 } from '../../../scripting';
...
import { MeshComponent as MeshComponent_2 } from '../../../scripting';
import { MeshLambertMaterial } from 'three';
import { MeshPhongMaterial } from 'three';
import { MeshStandardMaterial } from 'three';
import { MeshToonMaterial } from 'three';
import { MinificationTextureFilter } from 'three';
import { ModelComponent as ModelComponent_2 } from '../../../scripting';
import { MultiplayerComponent } from '../../components/multiplayer/multiplayercomponent';
import type { NarrowPhase } from '@dimforge/rapier3d';
import { NavMesh } from 'recast-navigation';
import { NavmeshComponent } from '../../components/navmesh/navmeshcomponent';
...
import { PlatformComponent as PlatformComponent_2 } from '../../../scripting';
import { PlayerData as PlayerData_3 } from '@oogg/game-mp-shared';
import { PortalComponent } from '../../components/portal/portalcomponent';
import { PostProcessingComponent as PostProcessingComponent_2 } from '../../../scripting';
import { PrefabResource as PrefabResource_2 } from '../prefabs/prefabresource';
import type { Provider } from 'ethers';
import { Quaternion } from 'three';
import type { QueryFilterFlags } from '@dimforge/rapier3d';
import { RainComponent as RainComponent_2 } from '../../../scripting';
...
import { ReflectorComponent as ReflectorComponent_2 } from '../../../scripting';
import { RigidBody } from '@dimforge/rapier3d';
import { RigidBodyType as RigidBodyType_3 } from 'engine/components/physics/types';
import { ScatterComponent } from '../../components/scatter/scattercomponent';
import { ScatterMeshComponent } from '../../components/scattermesh/scattermeshcomponent';
import type { Schema } from '@colyseus/schema';
import { ScriptComponent as ScriptComponent_2 } from '../api/scriptcomponent';
import type { ScriptResourceFactory } from '.';
import { ScriptResourceFactory as ScriptResourceFactory_2 } from './scripts';
import { Server } from '../@types/states';
import { ShaderMaterial } from 'three';
import { ShadowFloorComponent as ShadowFloorComponent_2 } from '../../../scripting';
...
import { SpawnComponent as SpawnComponent_2 } from '../../../scripting';
import { Sphere } from 'three';
import { Spherical } from 'three';
import { SplineComponent } from '../../components/spline/splinecomponent';
import { TerrainComponent as TerrainComponent_2 } from '../../../scripting';
import { TextComponent as TextComponent_2 } from '../../../scripting';
import { Texture } from 'three';
import * as _THREE from 'three';
import { TypedArray } from 'three';
import { Vector2 } from 'three';
import { Vector3 } from 'three';
import { VideoComponent as VideoComponent_2 } from '../../../scripting';
import { VRMAnimsComponent } from '../../components/vrmanims/vrmanimscomponent';
import { WalletWithMetadata } from '@privy-io/react-auth';
import { WaterComponent as WaterComponent_2 } from '../../../scripting';
import { WaveComponentData as WaveComponentData_2 } from './wavedata';
import { WebRTCComponent } from '../../components/webrtc/component';
import { WindComponent as WindComponent_2 } from '../../../scripting';
...
export declare class $Param {
    ...
    static Map<T>(itemType: T, opts?: MapParam): Record<string, InstanceType_2<T>>;
}
 ...
 */
declare class AgoraComponent_2 extends Component3D<AgoraComponentData> {
    voiceStreams: {};
    shareStreams: {};
    volumes: {};
    PartySocket: any;
...
export declare namespace Ai {
    ...
    export type AiType = StringType | NumberType | BooleanType | ArrayType | ObjectType | EnumType | UnionType;
    ...
    export function generateText(opts: Ai.AiGenOptions): Promise<Ai.GenTextResponse>;
...
declare class Augmented {
    ...
    emit(name: any, data: any, ...args: any[]): void;
    removeAllListeners(): void;
}

declare class Augmented_2 {
    private _mapEvent;
    constructor();
    on(name: any, callback: any): void;
    once(name: any, callback: any): void;
...
declare class AugmentedGroup extends Group<Object3DEventMap> {
    constructor();
    _mapEvent: {};
...
declare class AugmentedObject extends Object3D<Object3DEventMap> {
    constructor();
    _mapEvent: {};
    on(name: any, callback: any): void;
    once(name: any, callback: any): void;
...
export declare class AvatarComponent extends Component3D<AvatarComponentData> {
    ...
    protected _onCreateCollisionMesh(): Mesh<BoxGeometry, MeshBasicMaterial, Object3DEventMap>;
...
export declare interface BaseRoomState extends Schema {
    snapshotId: string;
    timestamp: number;
    settings: {
        tickRate: number;
    ...
    players: MapSchema<PlayerData_2>;
    addPlayer(player: PlayerData_2): void;
...
export declare class BasicCharacterController {
    ...
    _updateCollisionState(collider: Collider_3, playerCollider: Collider_2, collision: CharacterCollision): void;
    _updateIntersectionState(collider: Collider_3, playerCollider: Collider_2): void;
}
 ...
 */
declare class BatchComponent_2 extends Component3D<BatchComponentData> {
...
declare class BatchComponentEditor extends Component3DEditor<BatchComponent_2> {
    gui: {
        type: string;
        children: {
            Preset: {
    ...
    init(): void;
    duplicateBase(): Promise<Component3D<Component3DData_4>>;
    _selectionMesh: any;
    ...
    getDetailMeshes(): Mesh<BufferGeometry<NormalBufferAttributes>, Material | Material[], Object3DEventMap>[];
...
declare type BigIntify<T> = T extends number ? BigInt : {
 ...
 */
declare class BirdStaticComponent_2 extends Component3D<BirdStaticComponentData> {
...
declare class BirdStaticComponentEditor extends Component3DEditor<BirdStaticComponent_2> {
    gui: {
        type: string;
        children: {
            transform: {
 ...
 */
declare class CacheComponent_2 extends Component3D<CacheComponentData> {
 ...
 */
declare class CameraComponent_2 extends Component3D<CameraComponentData> {
    private _factory;
    ...
    _currentLookAtSpline: SplineComponent_2;
...
declare class CameraEditor extends Component3DEditor<CameraComponent_2> {
...
declare class Collider_2 {
    ...
    private _options;
    private _enabled;
    constructor(engine: PhysicsRapierWrapper, _colliderOpts: ColliderOpts, _parent: RigidBodyWrapper);
...
declare type ColliderOpts = CubeColliderOpts | SphereColliderOpts | CapsuleColliderOpts | CylinderColliderOpts | MeshColliderOpts;
...
export declare type ColliderType = "CUBE" | "MESH" | "SPHERE" | "CAPSULE" | "CYLINDER";

declare type ColliderType_2 = "CUBE" | "SPHERE" | "CAPSULE" | "CYLINDER" | "CONE" | "MESH";
...
declare class Component3DEditor<T extends Component3D<any> = Component3D> extends Augmented {
    ...
    attachTransfomControls(object: Object3D, opts: {
        callbacks?: {
            onDragStart?: () => void;
            onDragEnd?: () => void;
            onDrag?: () => void;
    ...
    dispatchDataChangeMulti(updates: Array<{
        id: string;
        changes: object;
        undo: object;
    }>): void;
    get data(): T["data"];
    protected createDefaultSelectionMesh(): Mesh<BoxGeometry, MeshBasicMaterial, Object3DEventMap>;
    getDetailMeshes(): Mesh[];
    onDetailMeshClicked(mesh: Mesh, intersect: Intersection<Mesh>): void;
    onDetailMeshMouseEnter(mesh: Mesh, intersect: Intersection<Mesh>): void;
    onDetailMeshMouseLeave(mesh: Mesh): void;
    get isFocusable(): boolean;
    getSelectionMesh(): Mesh<BufferGeometry<NormalBufferAttributes>, Material | Material[], Object3DEventMap>;
    selectionBox: any;
    ...
    protected getScriptGUI(context: EditorContext): {
        ...
        children: {
            scriptId: {
                ...
                name: string;
                nullable: boolean;
                value: (string | Component3DData_4)[];
            };
            scriptTag: {
                type: string;
                name: string;
...
export declare class ComponentManager extends AugmentedGroup {
    ...
    private _canLoad;
    get components(): Component3D<Component3DData_2>[];
    ...
    byInternalId(id: string): Component3D<Component3DData_2>;
    get loaded(): Promise<void>;
    /**
     * Returns a component by its id.
     */
    byId(id: string): Component3D<Component3DData_2>;
    /**
     * Returns all component with matching tag.
     * A tag is a string identifier that can be used to group components.
     */
    byTag(tag: string): Component3D<Component3DData_2>[];
    /**

     * Returns all components with matching type.
     */
    byType(type: string): Component3D<Component3DData_2>[];
    /**
     * Returns all components with matching name.
     */
    byName(name: string): Component3D<Component3DData_2>[];
    /**
     * Returns all components satisfying the given filter function.
     */
    filter(f: (c: Component3D) => boolean): Component3D<Component3DData_2>[];
    /**
     * Returns the first component satisfying the given filter function.
     */
    find(f: (c: Component3D) => boolean): Component3D<Component3DData_2>;
    /**
...
declare class ComponentsRegistry extends Augmented {
    ...
    getOrCreateFactory(type: any, opts: ComponentFactoryOptions): Promise<ComponentFactory<any>>;
...
export declare type ComponentTypes = {
    ...
    circle: CircleComponent_2;
    bullet: BulletComponent;
    godray: GodrayComponent;
    bird: BirdComponent;
    birdstatic: BirdStaticComponent_2;
    grass: GrassComponent_2;
    shadowfloor: ShadowFloorComponent;
    dust: DustComponent;
    impact: ImpactComponent_2;
    destination: DestinationComponent_2;
    dialog: DialogComponent_2;
    interaction: InteractionComponent_2;
    scatter: ScatterComponent_2;
    scattermesh: ScatterMeshComponent_2;
    instancedmesh: InstancedMeshComponent_2;
    portal: PortalComponent_2;
    camera: CameraComponent_2;
    spline: SplineComponent_2;
    cache: CacheComponent_2;
    agora: AgoraComponent_2;
    webrtc: WebRTCComponent_2;
    batch: BatchComponent_2;
    group: GroupComponent_2;
    iframe: IframeComponent_2;
    particles: ParticlesComponent_2;
    multiplayer: MultiplayerComponent_2;
    navmesh: NavmeshComponent_2;
};
 ...
 * @public
 */
declare class Contract extends EventEmitter_2 {
...
declare type ControllerInstance = DebugOrbitControlsWrapper | PlatformerController | ThirdPersonCameraControlsWrapper | FirstPersonCameraControlsWrapper | FlyCameraControlsWrapper | DefaultControlsWrapper;
...
export declare type ControlsType = "platformer" | "platformer2" | "default" | "thirdperson" | "firstperson" | "debugorbit" | "fly" | "smoothpf";
...
declare interface DataChangeOpts<Data extends Component3DData = Component3DData> {
    prev: Data;
    isProgress: boolean;
}
...
declare type DataPropNames<T> = {
    [K in keyof T]: T[K] extends Function ? never : K extends `_${string}` ? never : K extends "host" ? never : IfEquals<{
        [P in K]: T[K];
    }, {
        -readonly [P in K]: T[K];
    }, K, never>;
...
declare class DataSchema {
    ...
    private _unsetRec;
    forEachValue(obj: any, fn: (value: any, path: string, parent: any) => void): void;
...
declare type DecoratorFn = (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
 ...
 */
declare class DialogComponent_2 extends Component3D<DialogComponentData> {
    private _factory;
    private _dialog;
...
export declare function xfetch(url: string, opts?: RequestInit): Promise<Response>;
...
declare type EventResult<Inputs extends AnyMutArray<{
    name: string;
    internalType: string;
}>> = {
    [K in Inputs[number]["name"]]: BigIntify<ParseType<[Extract<Inputs[number], {
        name: K;
    }>]>>;
};
 ...
 * @public
 */
declare type FontFamily = "aeonik-bold" | "aeonik-medium" | "playfair-regular" | "playfair-italic";
...
declare type GameState = "GAME_PRELOAD" | "GAME_INIT" | "GAME_READY" | "GAME_START" | "GAME_UPDATE" | "GAME_END" | "GAME_DISPOSE" | "GAME_PAUSE" | "GAME_NOTIFY_PAUSE" | "GAME_NOTIFY_RESUME" | "GAME_RESUME" | "GAME_PRE_RENDER";
...
export declare class GameStorageApi {
     ...
     */
    get(key: string): Promise<Record_2>;
    /**
     * Get all stored values from the game storage.
     */
    getAll(): Promise<Record_2[]>;
    /**
     ...
     */
    getPlayerData(): Promise<Record_2>;
    /**
 ...
 */
declare class GrassComponent_2 extends Component3D<GrassComponentData> {
...
declare class GrassComponentEditor extends Component3DEditor<GrassComponent_2> {
    gui: {
        type: string;
        children: {
            transform: {
...
declare class GrassInstance {
    ...
    buildCollisionMesh(): Mesh<BufferGeometry<NormalBufferAttributes>, MeshBasicMaterial, Object3DEventMap>;
    updateFromSource(): void;
    destroy(): void;
}
 ...
 */
declare class GroupComponent_2 extends Component3D<GroupComponentData> {
    private _mesh;
    protected init(): Promise<void>;
    private _update3D;
 ...
 */
declare class IframeComponent_2 extends Component3D<IframeComponentData> {
    ...
    protected _onCreateCollisionMesh(): Mesh<BufferGeometry<NormalBufferAttributes>, Material | Material[], Object3DEventMap>;
...
export declare class ImageComponent extends Component3D<ImageComponentData> {
    ...
    protected _onCreateCollisionMesh(): Mesh<BufferGeometry<NormalBufferAttributes>, MeshBasicMaterial, Object3DEventMap>;
    protected _getBBoxImp(target: Box3): Box3;
    protected dispose(): void;
    /*****************************************************************
     *                      Public API
...
declare type InstanceType_2<T> = T extends new (...args: any[]) => infer R ? ItemType<R> : T;

declare class InteractionComponent_2 extends Component3D<InteractionComponentData> {
    _INTERACTION_EVENTS: {
        interaction: string;
    };
...
declare class InteractionFactory {
    ...
    initialisation: Promise<void>;
    dispose(): void;
    buildCollisionMesh: () => Mesh<BoxGeometry, MeshBasicMaterial, Object3DEventMap>;
    _material: MeshBasicMaterial;
...
declare type InterpolationVar = string | {
    key: string;
    getter?: Getter_2;
    method: LerpMethod;
};
...
declare class Interpolator {
    ...
    interpolate(snapshotA: Snapshot, snapshotB: Snapshot, timeOrPercentage: number, resolver: InterpolationResolver): void;
    private _setTo;
...
declare type Is1Length<T extends any> = T extends [any] ? true : T extends readonly [any] ? true : false;

export declare const IS_PARAM_VAL: unique symbol;

declare type ItemType<R> = R extends Number ? number : R extends String ? string : R extends Boolean ? boolean : R;
...
export declare class MainCamera extends AbstractCamera {
     ...
     */
    get controls(): FirstPersonCameraControlsWrapper | ThirdPersonCameraControlsWrapper | FlyCameraControlsWrapper;
    /**
...
declare type MakeArray<T extends {
    internalType: any;
    components?: any;
}, G extends string> = Array<ParseType<[
    {
 ...
 * @public
 */
declare type MaterialData = BasicMaterialData | LambertMaterialData | PhongMaterialData | StandardMaterialData | ToonMaterialData;
...
declare type MeshCompMaterial = MeshBasicMaterial | MeshLambertMaterial | MeshPhongMaterial | MeshStandardMaterial | MeshToonMaterial;
...
export declare class MeshComponent extends Component3D<MeshComponentData> {
    ...
    getCollisionMesh(): Mesh<BufferGeometry<NormalBufferAttributes>, MeshCompMaterial, Object3DEventMap>;
 ...
 */
declare class MultiplayerComponent_2 extends Component3D<any> {
    private _GameClient;
    private _playerSync;
    protected init(): Promise<void>;
    private _connect;
...
declare class NavmeshAgent extends Augmented {
    ...
    computePath(end: Vector3, debugPolys?: boolean): {
        polys: number[];
        points: Vector3[];
        nearStart: Vector3;
        nearEnd: Vector3;
 ...
 * @public
 */
declare class NavmeshComponent_2 extends Component3D<any> {
    private _worker;
    ...
    createAgent(position: Vector3, crowdAgentParams?: Partial<AgentParams>): NavmeshAgent;
    createAgent(host: Object3D, crowdAgentParams?: Partial<AgentParams>): NavmeshAgent;
...
declare class NavmeshCrowd extends Augmented {
    ...
    computePath(start: Vector3, end: Vector3, debugPolys?: boolean): {
        polys: number[];
        points: Vector3[];
        nearStart: Vector3;
        nearEnd: Vector3;
...
declare class NavmeshDebug extends Group {
    ...
    drawer: DebugDrawer;
    constructor(_component: NavmeshComponent_2);
    get crowd(): NavmeshCrowd;
    ...
    get collisions(): Mesh<BufferGeometry<NormalBufferAttributes>, Material | Material[], Object3DEventMap>[];
...
declare type Opt<T extends OptId> = T | {
    id: T;
    label?: string;
};
...
declare type ParseStruct<T extends {
    components?: {
        name: string;
        internalType: string;
    }[];
}> = {
    [K in T["components"][number]['name']]: ParseType<[Extract<T['components'][number], {
        name: K;
    }>]>;
};

declare type ParseType<T extends {
    internalType: any;
    components?: any;
}[]> = Is1Length<T> extends true ? (T[0]["internalType"] extends `${infer Rest}[]` ? MakeArray<T[0], Rest> : T[0]["internalType"] extends `uint${infer Rest}` ? number : T[0]["internalType"] extends `int${infer Rest}` ? number : T[0]["internalType"] extends `bool` ? boolean : T[0]["internalType"] extends `address` ? string : T[0]["internalType"] extends `bytes` ? string : T[0]["internalType"] extends `bytes${infer Rest}` ? string : T[0]["internalType"] extends `struct ${infer Rest}` ? ParseStruct<T[0]> : (T[0]["internalType"] | string)) : {
 ...
 */
declare class ParticlesComponent_2 extends Component3D<ParticlesComponentData> {
...
declare class PipeLineMesh extends Mesh<BufferGeometry<NormalBufferAttributes>, Material | Material[], Object3DEventMap> {
...
export declare class PlatformComponent extends Component3D<PlatformComponentData> {
    ...
    _onCreateCollisionMesh(): Mesh<BufferGeometry<NormalBufferAttributes>, MeshBasicMaterial, Object3DEventMap>;
    protected dispose(): void;
}
...
declare class PlatformerController extends ControlsAbstract implements PlatformerControlParams {
    private physics;
    private collider;
    private colliderRb;
    ...
    private opts;
    constructor(opts: Partial<PlatformerControlParams> & ConstructorParameters<typeof ControlsAbstract>[0]);
...
declare const PLAYER_ROLES_2: {
    readonly host: "host";
    readonly player: "player";
};

export declare interface PlayerAvatarOpts {
    collision?: boolean;
    avatarScale?: number;
    spawnData?: any;
    useMixer?: boolean;
...
declare interface PlayerData_2 {
    main?: boolean;
    sessionId: string;
    userId?: string;
    name: string;
...
declare type PlayerRole_2 = keyof typeof PLAYER_ROLES_2;
...
export declare class PrefabResource extends Resource<PrefabResourceData> {
    ...
    instantiate(opts: {
        ...
        abort?: AbortSignal;
        netId?: string;
    }): Promise<ModelComponent_2 | AudioComponent_2 | DialogComponent | IframeComponent | VideoComponent_2 | TerrainComponent_2 | EnvmapComponent_2 | BackgroundComponent_2 | LightingComponent_2 | TextComponent_2 | FogComponent_2 | CameraComponent | MeshComponent_2 | ImageComponent_2 | GroupComponent | AvatarComponent_2 | WaterComponent_2 | PostProcessingComponent_2 | ReflectorComponent_2 | RainComponent_2 | SpawnComponent_2 | VRMAnimsComponent | WindComponent_2 | KitBashComponent_2 | MagneticFieldComponent_2 | PlatformComponent_2 | CloudComponent_2 | CircleComponent | BulletComponent_2 | GodrayComponent_2 | BirdComponent_2 | BirdStaticComponent | GrassComponent | ShadowFloorComponent_2 | DustComponent_2 | ImpactComponent | DestinationComponent | InteractionComponent | ScatterComponent | ScatterMeshComponent | InstancedMeshComponent | PortalComponent | SplineComponent | CacheComponent | AgoraComponent | WebRTCComponent | BatchComponent | ParticlesComponent | MultiplayerComponent | NavmeshComponent>;
...
declare class PrefabResourceFactory extends ResourceFactory<PrefabResource> {
    ...
    updateResource(prefab: PrefabResource, data: PrefabResourceData): Promise<PrefabResource>;
...
/** @public */
export declare interface ProxyEmitter<T extends Record<string, any[]>> {
...
declare type RenderMode = "default" | "toon" | "glitch" | "ghost";
...
export declare class Resource<Data extends ResourceData = ResourceData> {
    ...
    getInstances(): Component3D_2<Component3DData_2>[];
    getDirectInstances(): Component3D_2<Component3DData_2>[];
...
declare class ResourceFactory<R extends Resource> {
    ...
    onInit(): Promise<void>;
    onDispose(): void;
    onResolve(resources: R[]): Promise<void>;
    private _updateComponentFactory;
    private _registerComponent;
    init(): Promise<void>;
    dispose(): void;
    resolve(resources: R[]): Promise<void>;
    getComponentFactory(proto: R): FactoryClass;
    onCreateResource(data: ResourceData): Promise<R>;
    createResource(data: ResourceData): Promise<R>;
...
declare class ResourceManager {
    ...
    createResource<T extends keyof ResourceByType>(data: ResourceData<T>, opts?: CreateOpts): Promise<ResourceByType[T]>;
    destroyResource(resource: Resource): void;
    updateResource<T extends Resource>(resource: T, data: T["data"], opts?: CreateOpts): Promise<void>;
    private setResource;
    ...
    filter(fn: (resource: Resource) => boolean): Resource<ResourceData<unknown>>[];
    forEach(fn: (resource: Resource) => void): void;
    getPrefab(id: string): PrefabResource;
    getScript(id: string): ScriptResource;
    get factories(): Record<string, ResourceFactory<any>>;
    get scriptFactory(): ScriptResourceFactory_2;
    get scripts(): ScriptResource[];
    get scriptsByUri(): Record<string, ScriptResource>;
    createPrefab(data: PrefabResourceData): Promise<PrefabResource>;
    private _getPrefabDataSingle;
    getPrefabDataFromInstance(instance: Component3D, meta: any, opts?: {
        parentId: string;
    }, idToPrefabId?: any): PrefabResourceData;
    _getDefChildMeta(instance: Component3D): {
        name: unknown;
        image: string;
    };
    getPrefabData(instance: Component3D, options: any): PrefabResourceData;
    getChildOverrideAddData(instance: Component3D, parentId: string): PrefabResourceData;
    getInstancesData(prefabData: PrefabResourceData, parent: PrefabResource, except?: Component3D): {};
    getVariantsData(prefabData: PrefabResourceData, parent: PrefabResource): {};
    getVariantData(prefabData: PrefabResourceData, parent: PrefabResource): PrefabResourceData;
    createFromInstance(instance: Component3D, meta: PrefabResourceData["meta"]): Promise<PrefabResource>;
...
export declare type RigidBodyType = "DYNAMIC" | "KINEMATIC" | "FIXED" | "PLAYER";
...
export declare function Rpc(opts?: RpcOptions): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;

export declare namespace Rpc {
    var Server: (opts: RpcOptions) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
    var Client: (opts: RpcOptions) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
    var ClientBroadcast: () => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
    var ServerNoReply: () => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
    var ClientNoReply: () => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
}
 ...
 */
declare class ScatterComponent_2 extends Component3D<ScatterComponentData> {
...
declare class ScriptDelegate {
    ...
    _scriptType: "component" | "behavior" | "lib";
...
declare interface ScriptModuleOpts {
    factory: ScriptResourceFactory;
    data: ScriptResourceData;
}

export declare type ScriptParam = StringParam | NumberParam | BooleanParam | ColorParam | AnimationParam | Vec2Param | Vec3Param | SelectParam | TriggerParam | ResourceParam | ComponentParam | SignalParam | ReceiverParam | GroupParam | ArrayParam | UnionParam | MapParam;

declare class ScriptResource extends Resource<ScriptResourceData> {
    ...
    _patch(opts: Omit<ScriptModuleOpts, "factory">): void;
    ...
    get scriptType(): "component" | "behavior" | "lib";
    get isComponent(): boolean;
    get isMain(): boolean;
    get isBehavior(): boolean;
    get isLib(): boolean;
    get hasComponentFactory(): boolean;
    get meta(): ComponentInfo_2;
    private get _dependencies();
    getDefaultComponentData(): any;
    get _params(): any[];
    getValuePaths(): string[];
    dependsOn(resource: Resource, visited?: {}): any;
    getPrefabs(): PrefabResource_2[];
    protected _disposeDelegate(delegate: ScriptDelegate): void;
    dispose(): void;
}

declare interface ScriptResourceData extends ResourceData<"script"> {
    /**
     * Component type
     */
    type: "script";
...
declare class ScriptRunner {
    opts: ScriptWrapperOpts;
    state: ScriptState;
    error: string;
    private _moduleFunc;
    private _runFunc;
    constructor(opts: ScriptWrapperOpts);
    private _eval;
    run(env?: Record<string, unknown>): unknown;
}

declare type ScriptState = keyof typeof STATES;

declare interface ScriptWrapperOpts {
    code: string;
...
export declare interface SelectParam<T extends OptId = string> extends AbstractParam<T> {
    type?: "select";
    options?: Options<T>;
 ...
 */
declare class SplineComponent_2 extends Component3D<SplineComponentData> {
 ...
 * @public
 */
export declare class Store<State> extends Augmented_2 {
    private _state;
...
/** @public */
declare type Testnet = "sepolia" | "oncyber:testnet" | "base:sepolia" | "solana:dev";
 ...
 * @public
 */
declare type TextTransform = "none" | "uppercase" | "lowercase" | "capitalize" | "togglecase";
...
declare type TransformConfigOpts = boolean | {
 ...
 */
declare class VRMAnimsComponent_2 extends Component3D<VRMAnimationsComponentData> {
...
declare class Web3Api {
    ...
    getTokenBalance: (mintAddr: string, chain?: Chain, address?: string) => Promise<number>;
    /**
     ...
     * Request funding.
     */
    requestFunding: (chain?: Chain, defaultAmount?: number) => Promise<{
        transaction: null;
        status: "error" | "closed" | "success";
    }>;
    /**
     ...
     */
    getDelegatedWallet: (chainType?: "solana" | "ethereum") => Promise<WalletWithMetadata>;
...
declare interface Web3Provider extends EventEmitter_2 {
    ...
    getTokenBalance(mintAddr: string, chain?: Chain, address?: string): Promise<number>;
    getDelegatedWallet: (chain?: "ethereum" | "solana") => Promise<WalletWithMetadata>;
}
 ...
 */
declare class WebRTCComponent_2 extends Component3D<WebRTCComponentData> {
    voiceStreams: {};
    shareStreams: {};
    volumes: {};
    PartySocket: any;
